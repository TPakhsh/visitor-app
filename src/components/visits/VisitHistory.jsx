// نسخه کامل VisitHistory.jsx با نمایش درست توضیحات (description یا note)
...
import {
  ...
  Filter, SortAsc, SortDesc, Store, Star, Info
} from "lucide-react";
...
export default function VisitHistory({ user }) {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen bg-gray-50">
      ...
      <div className="md:w-1/3 h-full overflow-y-auto p-4 space-y-4">
        ...
        <div className="flex flex-wrap gap-2 text-sm text-gray-700 items-center">
        ...
        {filtered.map(([storeName, storeVisits]) => {
          ...
          return (
            <div
              key={storeName}
              className="border border-gray-200 rounded-lg mb-4 shadow-sm bg-white overflow-hidden"
            >
              <button
